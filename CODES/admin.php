...
<section class="display-product-table"  id="#products">
...
<section class="edit-form-container5">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="update the product" name="update_product" class="btn" href= "a_style.css">
